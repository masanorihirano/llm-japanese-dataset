...
jq -s add `find datasets/*/data/ datasets-cc-by-sa/*/data/ -name "*.json" | sort` | jq '.[] | {instruction:.instruction, input:.input, output:.output}' | jq -s 'flatten' > data-cc-by-sa.json
